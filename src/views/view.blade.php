                    ...
                    <form class="form-horizontal">
                         <fieldset>
                              ...
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="text" placeholder="Customer ID" class="form-control input-md" maxlength="" tabindex="3">
                              ...
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="text" placeholder="Customer Status" class="form-control input-md" maxlength="" tabindex="4">
                                        <!--<span class="help-block">help</span>-->
                                   </div>
                              </div>
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="text" placeholder="Name" class="form-control input-md" maxlength="" tabindex="5">
                                        <!--<span class="help-block">help</span>-->
                                   </div>
                              </div>
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="number" placeholder="Landline #" class="form-control input-md" maxlength="" tabindex="6">
                                        <!--<span class="help-block">help</span>-->
                                   </div>
                              </div>
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="number" placeholder="Mobile #" class="form-control input-md" maxlength="" tabindex="7">
                                        <!--<span class="help-block">help</span>-->
                                   </div>
                              </div>
                              <div class="form-group col-md-6">
                                   ...
                                   <div class="col-md-8">
                                        <input id="" name="" type="email" placeholder="Email Address" class="form-control input-md" maxlength="" tabindex="8">
                                        <!--<span class="help-block">help</span>-->
                                   </div>
                              </div>
                              <div class="form-group col-md-6">
